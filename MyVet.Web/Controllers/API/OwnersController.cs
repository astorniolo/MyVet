...
{
    [Route("api/[controller]")] // ruteo del api
    [ApiController]
    ...
    public class OwnersController: ControllerBase
    {
        ...
        public OwnersController(DataContext dataContext)  //inyeccion a la bd
        {
            _dataContext = dataContext;
        }

        [HttpPost]//recomendacion de seguridad es que todos los get sean POST xq en el post los parametros van por en BODY ENCRIPTADO...(si mando los parametros fuera por ruta no van encryptados y cq  snifer los ve
